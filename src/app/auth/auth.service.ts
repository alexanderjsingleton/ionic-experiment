...
export class AuthService extends IonicAuth {
  ...
  private async addConfig() {
    ...
    const redirectUri = this.onDevice() ? 'com.okta.dev-670853:/callback' : 'http://localhost:8100/implicit/callback';
    const logoutRedirectUri = this.onDevice() ? 'com.okta.dev-670853:/logout' : 'http://localhost:8100/implicit/logout';
    const clientId = '0oarjt46eV5JvESrb356';
    const issuer = 'https://dev-670853.okta.com/oauth2/default';
